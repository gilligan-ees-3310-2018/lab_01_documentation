...
`format_md(sigma, digits = 1, format = "scientific")` will produce 
`r format_md(sigma, digits = 1, format = "scientific")`

`format_md(pi * 1E6, digits = 3, format = "scientific")` will produce 
`r format_md(pi * 1E6, digits = 3, format = "scientific")`

`format_md(pi * 1E6, digits = 3, format = "normal", comma = TRUE)` will produce 
`r format_md(pi * 1E6, digits = 3, format = "normal", comma = TRUE)`
