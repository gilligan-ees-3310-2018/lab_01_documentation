...
costly mistakes that cost JPM-Chase $6.2 billion. 
...
research paper on the effect of government debt on economic growth. This paper 
...
and was cited by Paul Ryan as highlighting the importance of dramatically 
cutting federal spending in the U.S.
...
Two important principles in sceince, which should prevent these errors,
...
To address these problems, the scientific commuinity is increasingly embracing the
...
However, a written description of the analysis process might inadvertantly omit crucial 
...
analysis procedure does not match the desccription in the published report, just
...
* Computational reproducibility provides detailed information on exactly how computations
    ...
    reports.
* Empirical reproducibilty provides detailed information about laboratory or field
...
* **Literate computing and authoring:** 
    Litrerate computing refers to mixing computer code with narrative description
...
* RStudio is available in many different options. What you want is the Open Source version of RStudio Desktop, which
    ...
    "ggalt", "GGAlly", "ggExtra", "ggmap", "ggspectra", "ggspatial", "ggspectra", 
...
research methods are both more efficient and also lead to higher quality reseearch.
