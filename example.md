...
![This is a plot of pressure versus temperature.](example_files/figure-html/graph_example-1.png)
...
`format_md(sigma, digits = 1)` will produce 5.7&times;10^-8^

`format_md(sigma, digits = 1, scientific = FALSE)` will produce 0.00000006

`format_md(pi * 1E6, digits = 3, scientific = TRUE)` will produce 3.142&times;10^6^
...
![](example_files/figure-html/example_layer_diagram-1.png)<!-- -->
